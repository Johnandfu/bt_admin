...
return array(
        ...
        '暴仓处理(退回保证金，结算总盈亏)' => 'Deficient processing (return of margin, settlement of total profit and loss)',
        '平仓资金处理' => 'Close position fund processing',
        '申请提币扣除余额' => 'Apply for withdrawal to deduct the balance',
        '申请提币冻结余额' => 'Apply for withdrawal to freeze balance',
        '闪兑扣除余额' => 'Contract transactions, deduct the balance',
        '闪兑增加锁定余额' => 'Contract transactions, increase the locked balance',
        '资产兑换,减少' => 'Asset exchange, reduction',
        '资产兑换,增加' => 'Asset exchange, increase',
        '通证兑换,增加' => 'Token exchange, increase',
        '充币增加' => 'Deposit increase',
        '充币记录' => 'Deposit record',
        '用户购买保险' => 'Users buy insurance',
        '保险赔偿用户[清除受保金额]' => 'Insurance compensation user [clear the insured amount]',
        '保险赔偿用户[赔偿受保金额]' => 'Insurance compensation user [compensation insured amount]',
        '保险解约，扣除保险金额' => 'Insurance termination, deduct the insurance amount',
        '保险解约，扣除受保金额' => 'Insurance termination, deduction of protected amount',
        '转账入余币宝' => 'Transfer into Yubibao',
        '锁仓' => 'Lock position',
        '锁仓返还' => 'Locked position return',
        '理财账户提现' => 'Withdrawal of wealth management account',
        '余币宝提现' => 'Yubibao cash withdrawal',
        '质押入账' => 'Pledge into the account',
        '系统删除' => 'System delete',
        '闪兑驳回，增加余额' => 'Contract rejected, increase balance',
        '闪兑扣除锁定金额' => 'Contract transactions, deduct the locked amount',
        '闪兑通过,增加余额' => 'Contract passed, increase balance',
        '提币成功' => 'Withdrawal successful',
        '提币失败,锁定余额减少' => 'Withdrawal failed, locked balance decreased',
        '提币失败,锁定余额撤回' => 'Withdrawal failed, locked balance released',
        '历史盈亏释放,增加杠杆币' => 'Release historical profits and losses, increase leveraged coins',
        '链上充币增加' => 'Increase in deposits on the chain',
        '秒合约订单,亏损结算' => 'Options order, loss settlement',
        '秒合约订单平仓,盈利结算' => 'Option order closing, profit settlement',

        "期权划转币币" => "Futures To Coin",
        "币币划转期权" => "Coin To Futures",
        "期权划转合约" => "Futures To Contract",
        "合约划转期权" => "Contract To Futures",
        "合约划转币币" => "Contract To exchange",
        "币币划转合约" => "Coin To Contract",
        "期权下单扣除本金" => "Option order deducts principal",
        "期权下单扣除手续费" => "Deduction of commission for option orders",
        "期权订单盈利结算" => "Option order profit settlement",
        "期权订单平局结算" => "No winning or losing settlement for option orders",
        "期权订单亏损结算" => "Option order loss settlement",
        "期权订单平仓无生效保险，资金不变" => "There is no effective insurance for option order closing, and the funds remain unchanged",
        "保险解约赔付金额" => "Insurance termination compensation amount",
        "保险解约扣除受保金额" => "Insurance cancellation deduction of insured amount",
        "保险解约扣除保险金额" => "Insurance cancellation deduction of insurance amount",
        "币币交易下单，资金冻结" => "Currency currency trading orders, the freezing of funds",
        "币币交易下单，冻结资金增加" => "Currency currency trading orders, increasing the freezing of funds",
        "币币交易冻结减少" => "Decrease in freezing of currency transactions",
        "币币交易成功" => "Currency transaction succeeded",
        "币币交易成功，冻结资金减少" => "The currency transaction is successful, and the frozen funds are reduced",
        "取消币币交易，资金返还" => "Cancel currency transactions, return funds",
        "取消币币交易，退换冻结资金" => "Cancel currency transactions and refund frozen funds",
        "取消币币交易" => "Cancel currency transaction",
        "杠杆交易,扣除保证金" => "Contract transaction, deduct margin",
        "杠杆交易,扣除手续费" => "Contract transaction, deduction of handling fee",
        "杠杆委托撤单,退回手续费" => "Contract cancellation, refund of handling fee",
        "杠杆委托撤单,退回保证金" => "Contract cancellation, refund of margin",
        ...
        '您的实名认证还未通过！' => 'Your ID number is not certified!',
        ...
        '与初级认证证件不一致' => 'The ID number is inconsistent with the primary certification',
        '项目不存在' => 'Item does not exist',
        '最少存入数量为：' => 'Minimum deposit amount is: ',
        '找不到存单' => 'Can not find certificates of deposit',
        '非法操作' => 'Illegal operation',
        '存单状态异常' => 'Abnormal deposit status',
        '毁约成功' => 'Successfully broke the contract',
        '存币成功' => 'Deposit money successfully',
        '下注金额不可小于' => 'The bet amount cannot be less than ',
        '最低申购数量为：' => 'The minimum order quantity is ',
        '最多申购数量为：' => 'The maximum purchase quantity is ',
        '新币申购' => 'SGD subscription',
        '申购成功' => 'The subscription is successful',
        '请联系在线客服，获取购买资格!' => 'Please contact online customer service to obtain purchase qualifications!',
        '已售磐' => 'sold pan',
        '您好，您的账户已被冻结，详情请咨询客服。' => 'Hello, your account has been frozen, please contact customer service for details.',
