                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="" name="title_Name"
                                    type="text" onkeyup=""
                                    value="@if(isset($setting['title_Name'])){{$setting['title_Name'] ?? ''}}@endif">
                            </div>
                        </div>
                        
                        <div class="layui-form-item">
                            <label class="layui-form-label">推广注册链接</label>
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="默认为域名后面加/h5/#/pages/user/login/register" name="share_url"
                                    type="text" onkeyup="" 
                                    value="@if(isset($setting['share_url'])){{$setting['share_url'] ?? ''}}@endif">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">一级邀请佣金比</label>
                                <div class="layui-input-inline">
                                    <input class="layui-input" lay-verify="1" placeholder="建议5" name="partner_ratio_lv1"
                                        type="text" onkeyup="" 
                                        value="@if(isset($setting['partner_ratio_lv1'])){{$setting['partner_ratio_lv1'] ?? ''}}@endif">
                                </div>
                                <div class="layui-form-mid layui-word-aux">%</div>
                            </div>
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">二级邀请佣金比</label>
                                <div class="layui-input-inline">
                                    <input class="layui-input" lay-verify="1" placeholder="建议4" name="partner_ratio_lv2"
                                        type="text" onkeyup="" 
                                        value="@if(isset($setting['partner_ratio_lv2'])){{$setting['partner_ratio_lv2'] ?? ''}}@endif">
                                </div>
                                <div class="layui-form-mid layui-word-aux">%</div>
                            </div>
                            
                            <div class="layui-inline">
                                <label class="layui-form-label">三级邀请佣金比</label>
                                <div class="layui-input-inline">
                                    <input class="layui-input" lay-verify="1" placeholder="建议3" name="partner_ratio_lv3"
                                        type="text" onkeyup="" 
                                        value="@if(isset($setting['partner_ratio_lv3'])){{$setting['partner_ratio_lv3'] ?? ''}}@endif">
                                </div>
                                <div class="layui-form-mid layui-word-aux">% 用户充值时给上级返佣</div>
                            </div>
                        </div>
                       ...
                       <div class="layui-inline"></div>
                        <div class="layui-form-item layui-form-text">
                			...
                			<div class="layui-input-block">
                				...
                				<br>
                				<img src="{{$setting['cover'] ?? ''}}" id="img_cover" class="cover" style="display: @if(!empty($setting['cover'])){{"block"}}@else{{"none"}}@endif;max-width: 200px;height: auto;margin-top: 5px;">
                				<input type="hidden" name="cover" id="cover" value="{{$setting['cover'] ?? ''}}">
                			</div>
                		</div>
                    </div>
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="" name="BANK_NAME"
                                    type="text" onkeyup=""
                                    value="@if(isset($setting['BANK_NAME'])){{$setting['BANK_NAME'] ?? ''}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">开户姓名</label>
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="" name="BANK_USERNAME"
                                    type="text" onkeyup=""
                                    value="@if(isset($setting['BANK_USERNAME'])){{$setting['BANK_USERNAME'] ?? ''}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">银行卡号</label>
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="" name="BANK_CODE"
                                    type="text" onkeyup=""
                                    value="@if(isset($setting['BANK_CODE'])){{$setting['BANK_CODE'] ?? ''}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">客服链接</label>
                            <div class="layui-input-block">
                                <input class="layui-input" lay-verify="1" placeholder="" name="customer_url"
                                    type="text" onkeyup=""
                                    value="@if(isset($setting['customer_url'])){{$setting['customer_url'] ?? ''}}@endif">
                            </div>
                        </div>
